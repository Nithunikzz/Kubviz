...
CREATE TABLE IF NOT EXISTS kubescore (
	...
	objectmetageneratename String,
	objectannoations String,
	kind String,
	apiversion String,
	filename String,
	filerow  BIGINT,
...
const InsertKubeScore string = "INSERT INTO kubescore(id,clustername,objectname,objectnamespace,objectmetaname,objectmetageneratename,objectannoations,kind,apiversion,filename,filerow,checks,checks_id,comments,grade,checktargettype)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
